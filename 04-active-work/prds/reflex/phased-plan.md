...
| --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| Data processing summaries from Zendesk, Fin into BigQuery | Process our Closed Zendesk ticket comments  and Fin conversations into a database source of truth. Can run this daily.Assume all metadata in scope for summaries. | Engineering<br /><br />Consulted: Analytics          |
| Knowledge base                                            | Pick which parts are relevant for the prompt output, minimum:* PSP context* Checkout context* Checkout Terminology* Product definitions                           | Engineering<br /><br />Consulted: Product, Analytics |
| Pick the right LLM for this work                          | Test a few LLMs for right output vs cost.                                                                                                                         | All                                                  |
| Prompting logic for summaries                             | The prompt logic to create the summaries. Store this in BedrockNeed to ensure business context and terminology so this is correctly kept.                         | Product, Analytics, Consulted: Engineering           |
| Logic for aggregation of insights                         | The prompt logic to create the aggregated insights. Store this in Bedrock                                                                                         | Product, Analytics<br /><br />Consulted: Engineering |
| Model versioning                                          | Ensure we maintain versioning of the models we use for LLMs - Bedrock?                                                                                            | Analytics<br /><br />Consulted: Product, Eng         |
| Quality assurance layer - summaries                       | Quality assurance process to check summaries are right standard                                                                                                   | Analytics<br /><br />Consulted: Product, Eng         |
| Quality assurance layer - aggregations                    | Quality assurance process to check aggregated insights are right standard                                                                                         | Analytics<br /><br />Consulted: Product, Eng         |
| Query interface                                           | An interface which users can pull insights on demand                                                                                                              | Engineering<br />Consulted: Product, Analytics       |
| Reporting mechanism                                       | We can output a monthly/quarterly report for sharing with wider business - monthly EP newsletter, with Product pillar leaders                                     | Analytics<br />Consulted: Product, Eng               |

---

### Phase 3 — Q3 2026: Add NPS data, Contact Spike Detection, Measure Fixes from Product
