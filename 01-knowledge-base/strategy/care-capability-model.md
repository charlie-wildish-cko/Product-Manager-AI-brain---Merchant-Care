...
| **Support channels — B2B** | Fin, Email, Dashboard contextual | L2 — **Fin**: Dashboard + email partially deployed; Dashboard contextual answers live Q1; webform still primary for many merchants | L3 — **Fin**: primary B2B channel; webform retired Q3; Dashboard contextual live; **Success Plans**: phone available for Premium merchants | L3 — **Success Plans**: phone extended to Enterprise; IM/Slack piloted | L3 — IM/Slack live across eligible tiers | L4 — **Fin**: majority of B2B volume; all channels integrated; webform fully deprecated | Channel mix %; Fin resolution rate | Fin CC handoff capability required before webform retirement (Q3 2026) |
| **Support channels — B2C** | Fin, Mobile app, Phone | L0 | L2 — **Fin**: deployed on B2C at wallet launch; phone live from day one (required at launch); mobile app support channel defined | L3 — In-app support embedded in product UX; **Success Plans**: B2C tiered channel access live | L3 — Stable | L4 — **Fin**: AI-first for all B2C channels; support embedded in product experience | B2C channel mix %; B2C AI resolution rate | Fin B2C configuration; Consumer Duty requirements defined before launch |
...
| Capability | Care Products | 2026 | 2027 | 2028 | 2029 | 2030 | Metric | Blocker / Dependency |
|---|---|---|---|---|---|---|---|---|
| **Intent classification** | Fin, Zendesk | L2 — **Fin**: classification live for Dashboard and email contacts; **Zendesk**: manual routing for edge cases and complex contacts | L3 — **Fin**: classification across all B2B channels + B2C at wallet launch | L3 — **Fin**: banking reason types classifiable | L3 — High accuracy; measured per reason type | L4 — **Fin**: self-improving classification; accuracy >95% | Classification accuracy %; first assignment time | B2C taxonomy (2027); banking taxonomy (2028) must exist before classification can extend |
| **Channel eligibility rules** | Customer 360, Success Plans, Zendesk | L1 — No eligibility rules live at year start; **Success Plans** rules engine starts Q2 | L2 — **Success Plans**: Standard/Enterprise/Premium B2B rules live; B2C channel rules defined at wallet launch | L3 — Banking merchant eligibility added | L3 — **Success Plans**: stable across all segments | L4 — **Customer 360**: real-time eligibility; adapts dynamically on merchant lifecycle events | Routing accuracy %; routed ticket acceptance rate | Customer 360 data completeness; Support model (Q2–Q3 2026) |
...
| Capability | Care Products | 2026 | 2027 | 2028 | 2029 | 2030 | Metric | Blocker / Dependency |
|---|---|---|---|---|---|---|---|---|
| **B2B ticketing** | Zendesk | L2 — **Zendesk**: live for B2B; basic routing; no skill-based assignment yet | L3 — **Zendesk**: skill-based routing live; SLA rules per merchant level; Jira integration live | L3 — **Zendesk**: banking ticket categories added; AM/TAM escalation flows updated | L3 — Stable | L4 — **Zendesk**: automated ticket classification, routing, and SLA management | Tickets handled within SLA %; AHT | Support model rollout (Q3 2026); Zendesk configuration |
| **B2C ticketing** | Zendesk | L0 | L2 — **Zendesk**: B2C brand scaled at wallet launch; Consumer Duty complaint handling process live | L3 — **Zendesk**: banking complaint flows added; vulnerable customer flags surfaced | L3 — Stable | L4 — **Zendesk**: full B2C + B2B routing; automated classification across both | B2C AHT; complaint resolution time | Zendesk B2C configuration; Consumer Duty and complaint handling process design (2026) |
...
| **Salesforce integration** | Zendesk | L1 — Manual handoff for SF-owned contacts | L2 — **Zendesk**: Salesforce integration scoped (TBC — depends on commercial team alignment) | L3 — **Zendesk**: bi-directional sync live if confirmed | L3 — Stable if live | L4 — Automated routing for SF-owned contacts | SF ticket handoff time; duplicate handling rate | Commercial team alignment on shared ticket ownership; TBC |
